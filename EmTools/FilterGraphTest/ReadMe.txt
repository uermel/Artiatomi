========================================================================
    KONSOLENANWENDUNG: FilterGraphTest-Projektübersicht
========================================================================

Diese FilterGraphTest-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre FilterGraphTest-Anwendung besteht.


FilterGraphTest.vcxproj
...
FilterGraphTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen FilterGraphTest.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
