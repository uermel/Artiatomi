========================================================================
    KONSOLENANWENDUNG: OpenCLTest-Projektübersicht
========================================================================

Diese OpenCLTest-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre OpenCLTest-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen OpenCLTest.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
