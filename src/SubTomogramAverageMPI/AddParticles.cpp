...
int main(int argc, char* argv[])
{
	...
	int iter = aConfig.StartIteration;
	{
...

        {
            ...
            CudaRot rot(size, stream, ctx, CR_INTERP_LINEAR);// aConfig.LinearInterpolation);
            ...
            for (size_t ref = 0; ref < aConfig.Reference.size(); ref++)
            {
                ...
                if (mpi_part == 0)
                {
                    ...
                    {
                        auto tem = new float[size*size*size];
                        d_sphAvg_wedge.CopyDeviceToHost(tem);
                        stringstream ss1;
                        string outName = aConfig.Path + aConfig.Reference[ref] + "sphAvg_";
                        ss1 << outName << iter << ".em";
                        emwrite(ss1.str(), tem, size, size, size);
                        delete[] tem;
                    }
...
//                    {
//                        stringstream ss1;
//                        string outName = aConfig.Path + aConfig.Reference[ref] + "input1_";
//                        ss1 << outName << iter << ".em";
//                        emwrite(ss1.str(), sumE, size, size, size);
//                    }
//
//                    {
//                        stringstream ss1;
//                        string outName = aConfig.Path + aConfig.Reference[ref] + "input2_";
//                        ss1 << outName << iter << ".em";
//                        emwrite(ss1.str(), sumO, size, size, size);
//                    }
//
//                    {
//                        stringstream ss1;
//                        string outName = aConfig.Path + aConfig.Reference[ref] + "input3_";
//                        ss1 << outName << iter << ".em";
//                        emwrite(ss1.str(), sumAll, size, size, size);
//                    }
...
//                    {
//                        stringstream ss1;
//                        string outName = aConfig.Path + aConfig.Reference[ref] + "regularized_";
//                        ss1 << outName << iter << ".em";
//                        emwrite(ss1.str(), recon, size, size, size);
//                    }
//
//                    {
//                        auto tmp = new float[size*size*size];
//                        for (int i=0; i<size*size*size; i++){
//                            tmp[i] = (float)regParam[i];
//                        }
//                        stringstream ss1;
//                        string outName = aConfig.Path + aConfig.Reference[ref] + "params_";
//                        ss1 << outName << iter << ".em";
//                        emwrite(ss1.str(), tmp, size, size, size);
//                        delete[] tmp;
//                    }
