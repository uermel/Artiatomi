...
BPLUTKernel::BPLUTKernel(CUmodule aModule, dim3 aGridDim, dim3 aBlockDim)
        : CudaKernel("backProjectionLUT", aModule, aGridDim, aBlockDim, 0)
{

}

BPLUTKernel::BPLUTKernel(CUmodule aModule)
        : CudaKernel("backProjectionLUT", aModule, make_dim3(1, 1, 1), make_dim3(2, 2, 2), 0)
{
...
float BPLUTKernel::operator()(int proj_x,
                              ...
                              float LUTcenter)
{
    CUsurfObject projPtr = projection.GetDevicePtr();
...
void SetConstantValues(BPLUTKernel& kernel, Volume<float>& vol, Projection& proj, int index, int subVol, Matrix<float>& m, Matrix<float>& mInv)
{
    //printf("==============================================================\n");
