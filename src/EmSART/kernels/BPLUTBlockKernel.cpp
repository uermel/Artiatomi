...
BPLUTBlockKernel::BPLUTBlockKernel(CUmodule aModule, dim3 aGridDim, dim3 aBlockDim)
        : CudaKernel("backProjectionLUTVoxelBlock", aModule, aGridDim, aBlockDim, 0)
{

}

BPLUTBlockKernel::BPLUTBlockKernel(CUmodule aModule)
        : CudaKernel("backProjectionLUTVoxelBlock", aModule, make_dim3(1, 1, 1), make_dim3(4, 4, 4), 0)
{

}

float BPLUTBlockKernel::operator()(int proj_x,
                                int proj_y,
                                float lambda,
                                float maxOverSample,
                                ...
                                Volume<float>* vol)
{
    ...
    SetDynamicSharedMemory(sizeof(float) * 72 * 2 * 2 * 2);
...
void SetConstantValues(BPLUTBlockKernel& kernel, Volume<float>& vol, Projection& proj, int index, int subVol, Matrix<float>& m, Matrix<float>& mInv)
{
    //printf("==============================================================\n");
