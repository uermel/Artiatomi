...
RectToSqrSlice::RectToSqrSlice(CUmodule aModule, dim3 aGridDim, dim3 aBlockDim)
        : CudaKernel("rect2squareSlices", aModule, aGridDim, aBlockDim, 0)
{

}

RectToSqrSlice::RectToSqrSlice(CUmodule aModule)
        : CudaKernel("rect2squareSlices", aModule, make_dim3(1, 1, 1), make_dim3(4, 4, 4), 0)
{

}

float RectToSqrSlice::operator()(CudaPitchedDeviceVariable& aIn,
                                           int maxsize,
