...
BPLUTBWKernel::BPLUTBWKernel(CUmodule aModule, dim3 aGridDim, dim3 aBlockDim)
        : CudaKernel("backProjectionLUTBlockwiseDiff", aModule, aGridDim, aBlockDim, 0)
{

}

BPLUTBWKernel::BPLUTBWKernel(CUmodule aModule)
        : CudaKernel("backProjectionLUTBlockwiseDiff", aModule, make_dim3(1, 1, 1), make_dim3(4, 4, 4), 0)
{

}

float BPLUTBWKernel::operator()(int proj_x,
                              int proj_y,
                              float lambda,
                              float maxOverSample,
                              ...
                              Volume<float>* vol)
{
    ...
    SetGridDimensions(make_dim3(gridX, 1, 1));
...
void SetConstantValues(BPLUTBWKernel& kernel, Volume<float>& vol, Projection& proj, int index, int subVol, Matrix<float>& m, Matrix<float>& mInv)
{
    //printf("==============================================================\n");
