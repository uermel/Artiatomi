...
RectSliceToSqrSliceKernel::RectSliceToSqrSliceKernel(CUmodule aModule, dim3 aGridDim, dim3 aBlockDim)
        : CudaKernel("rectSlices2squareSlices", aModule, aGridDim, aBlockDim, 0)
{

}

RectSliceToSqrSliceKernel::RectSliceToSqrSliceKernel(CUmodule aModule)
        : CudaKernel("rectSlices2squareSlices", aModule, make_dim3(1, 1, 1), make_dim3(4, 4, 4), 0)
{

}

float RectSliceToSqrSliceKernel::operator()(CudaDeviceVariable& aIn,
                                            int proj_x,
                                            int proj_y,
                                            int maxsize,
