...
SqrSliceToRectSliceKernel::SqrSliceToRectSliceKernel(CUmodule aModule, dim3 aGridDim, dim3 aBlockDim)
        : CudaKernel("squareSlices2rectSlices", aModule, aGridDim, aBlockDim, 0)
{

}

SqrSliceToRectSliceKernel::SqrSliceToRectSliceKernel(CUmodule aModule)
        : CudaKernel("squareSlices2rectSlices", aModule, make_dim3(1, 1, 1), make_dim3(4, 4, 4), 0)
{

}

float SqrSliceToRectSliceKernel::operator()(CudaDeviceVariable& aIn,
                                            int proj_x,
                                            int proj_y,
                                            int maxsize,
