...
/////////////////////////////////////
        ...
        //uint3 partDimUFFT = make_uint3(psize/2+1, psize, psize);
        ...
        //particle.LoadFromFile("/home/uermel/EMPIAR-10304/data/joint_reconstruction/initial_test/work21/iter_particle_22_2.em", 0);
        //deviceParticle.HostToCard(&particle, 0);

        //vol->LoadFromFile("/home/uermel/EMPIAR-10304/data/joint_reconstruction/initial_test/work21/volume_2.em", 0);
        //deviceVolume.HostToCard(vol, 0);
        ...
        // Get motl
        //MotiveList motiveList("/home/Group/Share/lamella_test/test2/EmSART/test_2k/motl_t121_plusShift_1k.em", 1, 1);
        //motiveList.selectTomo(28);
        ...
        float* dist = new float[proj.GetProjCount() * proj.GetWidth() * proj.GetHeight()];
...
//                                                            stackIdx, false, iter, true);

                {
                    ...
                    stringstream DP;
                    DP << "forward_parent_only_" << stackIdx << "_" << iter << ".em";
                ...
                //reconstructor.ResetProjectionsDevice();
                reconstructor.ForwardProjectionChildren(vol,
                                                      particles,
                                                      deviceParticle,
                                                      deviceMask,
                                                      stackIdx, false, iter, true);
                ...
                {
                    auto img = new float[proj.GetWidth() * proj.GetHeight()];
                    reconstructor.CopyChildProjectionToHost(img);
                    stringstream DP;
                    DP << "forward_children_only_" << stackIdx << "_" << iter << ".em";
                    emwrite(DP.str(), img, proj.GetWidth(),
                            proj.GetHeight());
                    delete[] img;
                }
...
//                                                            stackIdx, false, iter, true);
                ...
                reconstructor.CompareSpecial(vol, particles[0], projSource->GetProjection(stackIdx), stackIdx, true, iter);
...
//                    }
//                    stringstream DP;
//                    DP << "iter_particle_before_" << stackIdx << "_" << iter << ".em";
