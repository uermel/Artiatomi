...
/////////////////////////////////////
        ...
        if (aConfig.ContinueRec){
            particle.LoadFromFile(aConfig.ReferenceEM, 0);
...
/////////////////////////////////////
        ...
        for (int iter = 0; iter < aConfig.Iterations; iter++) {
            for (uint projIdx = 0; projIdx < projCount; projIdx++) {
                ...
                if (aConfig.AverageOverlap) {
                    reconstructor.ForwardProjectionConjoinedChildren(vol,
                                                                     particles,
                                                                     *deviceVolume,
                                                                     deviceParticle,
                                                                     deviceMask,
                ...
                reconstructor.PowerChildren(particles,
                                            deviceParticle,
                                            deviceMask,
                                            stackIdx, iter);
                ...
                // Backproject noise
                reconstructor.BackProjectionOrphans(vol,
                                                    particles,
                                                    deviceNoise,
                                                    deviceMask,
                                                    deviceMultiplicity,
                ...
                reconstructor.PowerOrphans(particles,
                                           deviceNoise,
                                           deviceMask,
                                           stackIdx, iter);
...
/////////////////////////////////////
        ...
        if (mpi_part == 0)
        {
            ...
            filenameEM = aConfig.ReferenceEM;
            filenameMRC = aConfig.ReferenceMRC;
