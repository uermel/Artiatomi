...
namespace Cuda
{
    ...
    public:
        CudaTextureObject1D(CUaddress_mode aAddressMode0,
    ...
    public:
        CudaTextureObject2D();
        CudaTextureObject2D(CUaddress_mode aAddressMode0,
                            CUaddress_mode aAddressMode1,
                            CUfilter_mode aFilterMode,
                            uint aTexRefSetFlag,
                            CudaPitchedDeviceVariable* aData,
                            CUarray_format aDataFormat, uint aNumChannels);
    ...
    public:
        CudaTextureObject3D();
        CudaTextureObject3D(CUaddress_mode aAddressMode0,
                            CUaddress_mode aAddressMode1,
