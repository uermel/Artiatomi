...
namespace Cuda
{
    CudaTextureObject1D::CudaTextureObject1D(CUaddress_mode aAddressMode0,
              ...
              mResViewDesc({})
    {
        ...
        mTexDesc.addressMode[1] = aAddressMode0;
        mTexDesc.addressMode[2] = aAddressMode0;
    ...
    void CudaTextureObject1D::Bind(CUaddress_mode aAddressMode0,
                                   CUfilter_mode aFilterMode,
                                   uint aTexRefSetFlag,
                                   CudaArray1D* aArray,
                                   CUarray_format aDataFormat,
    ...
    CudaTextureObject1D::CudaTextureObject1D()
            : mCleanUp(false),
              mData(nullptr),
              mArray(nullptr),
              mTexObj(0),
    ...
    CUtexObject CudaTextureObject1D::GetTexObject()
    {
        return mTexObj;
    }
    ...
    CudaTextureObject3D::CudaTextureObject3D()
            : mCleanUp(false),
              mArray(nullptr),
              mTexObj(0),
              mResDesc({}),
    ...
    CudaTextureObject3D::CudaTextureObject3D(CUaddress_mode aAddressMode0,
                                             CUaddress_mode aAddressMode1,
                                             CUaddress_mode aAddressMode2,
                                             CUfilter_mode aFilterMode,
                                             uint aTexRefSetFlag,
                                             CudaArray3D* aArray)
            : mCleanUp(false),
    ...
    void CudaTextureObject3D::Bind(CUaddress_mode aAddressMode0,
                                   CUaddress_mode aAddressMode1,
                                   CUaddress_mode aAddressMode2,
                                   CUfilter_mode aFilterMode,
                                   uint aTexRefSetFlag,
    ...
    CudaArray3D* CudaTextureObject3D::GetArray()
    {
        return mArray;
    }

    CUtexObject CudaTextureObject3D::GetTexObject()
    {
        return mTexObj;
    }
