...
uint Dm4FileTag::GetSize(ulong64 typeID)
{
	uint totalSize = 0;
	switch (typeID)
		{
...
uint Dm4FileTag::GetSizePixel(ulong64 typeID)
{
	uint totalSize = 0;
	switch (typeID)
		{
...
void Dm4FileTag::PrintSingleValue(ostream& aStream, ulong64 aType, uint aStartPos)
{
	switch (aType)
	{
		case DTTI2:
...
int Dm4FileTag::GetSingleValueInt(ulong64 aType, uint aStartPos)
{
	switch (aType)
	{
		case DTTI2:
...
float Dm4FileTag::GetSingleValueFloat(ulong64 aType, uint aStartPos)
{
	switch (aType)
	{
		case DTTI2:
...
double Dm4FileTag::GetSingleValueDouble(ulong64 aType, uint aStartPos)
{
	switch (aType)
	{
		case DTTI2:
...
string Dm4FileTag::GetSingleValueString(ulong64 aType, uint aStartPos)
{
	switch (aType)
	{
	case DTTUI2:
