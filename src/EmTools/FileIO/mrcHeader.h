...
#define MRC_IMODFLAG 1146047817
...
struct struct_MrcHeader
{
	...
	//! Bit flags: 	1 = bytes are stored as signed  2 = pixel spacing was set from size in extended header 4 = origin is stored with sign inverted from definition below
	int IMODFlags;
